...
function handleDetail(e){
    ...
    detailPrice.innerHTML= 'Price : Php ' +data[getId].price;
    youSave.innerHTML= 'You save : (Php ' + data[getId].save + ')';
}
...
function addItem(){
    ...
    var clrNode=document.getElementById('item-body');
        ...
        document.getElementById('total-amount').innerHTML = 'Total Amount : Php ' + totalAmount;
        document.getElementById('total-items').innerHTML = 'Total Items : ' + totalItems;
        document.getElementById('you-saved').innerHTML = 'You Saved : Php ' + totalSaving;
